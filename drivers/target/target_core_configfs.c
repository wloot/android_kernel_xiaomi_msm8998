	...
	const char *name)
{
	...
	dev_cg->default_groups = kmalloc_array(6,
	...
	tg_pt_gp_cg->default_groups = kmalloc_array(2,
						    sizeof(struct config_group *),
						    GFP_KERNEL);
	...
	dev_stat_grp->default_groups = kmalloc_array(4,
						     sizeof(struct config_group *),
						     GFP_KERNEL);
...
static int __init target_core_init_configfs(void)
{
	...
	target_cg->default_groups = kmalloc_array(2,
						  sizeof(struct config_group *),
						  GFP_KERNEL);
	...
	hba_cg->default_groups = kmalloc_array(2,
					       sizeof(struct config_group *),
					       GFP_KERNEL);
	 ...
	 */
	alua_cg = &alua_group;
	alua_cg->default_groups = kmalloc_array(2,
						sizeof(struct config_group *),
						GFP_KERNEL);
	...
	lu_gp_cg->default_groups = kmalloc_array(2,
						 sizeof(struct config_group *),
						 GFP_KERNEL);
